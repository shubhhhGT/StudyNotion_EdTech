                    ...
                    Timeline.map((element, index) => {
                        return (
                            <div className='flex flex-col lg:gap-3 ' key={index}>
                                ...
                                <div className={`${Timeline.length - 1 === index ? 'hidden' : 'block'} h-14 border-dotted border-r border-richblack-100 bg-richblack-400/0 w-[26px]`}>
            ...
            <div className="relative w-fit h-fit shadow-blue-200 shadow-[0px_0px_30px_0px]">
                ...
                <div className='absolute lg:left-[50%] lg:bottom-0 lg:translate-x-[-50%] lg:translate-y-[50%] bg-caribbeangreen-700 flex lg:flex-row flex-col text-white uppercase py-5 gap-4 lg:gap-0 lg:py-10 '>
                    <div className='flex gap-5 items-center lg:border-r border-caribbeangreen-300 px-7 lg:px-14'>
                        ...
                        <p className='text-sm text-caribbeangreen-300 w-[75px]'>Years of Experience</p>
                    </div>
                ...
                {/* Timeline image */}
                <img className='shadow-white shadow-[20px_20px_0px_0px] object-cover h-[400px] lg:h-fit' src={timelineimage} alt='timelineimage' />
